...
def letter_box_image(image: Image.Image, output_height: int, output_width: int, fill_value)-> np.ndarray:
    ...
    print("DEBUG letter box: pad top and left:", pad_top, pad_left)
    print("DEBUG letter box: fit_image.shape", fit_image.shape)
    to_return[pad_top:pad_top+fit_height, pad_left:pad_left+fit_width] = fit_image
    print("DEBUG letter box: to_return.shape", to_return.shape)
    return to_return
